...
code = code.replace(
    '<img src="/visit.png" alt="Your Page" className="w-8 h-8 rounded-full object-cover shrink-0 border border-gray-200 dark:border-gray-700" />',
    '<img src="/visit.png" alt="Your Page" className="w-9 h-9 p-1.5 object-contain" />'
);
fs.writeFileSync('src/app/[locale]/home/page.tsx', code);
console.log('Fixed icon class');
