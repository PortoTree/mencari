                ...
                {dummyChats.map((chat, idx) => (
                  <div
                    ...
                    className={`relative group flex items-center gap-3 p-3 hover:bg-gray-200 dark:hover:bg-[#3A3B3C] cursor-pointer transition-colors ${
                      activeChatIdx === idx ? "bg-gray-200 dark:bg-[#3A3B3C]" : ""
                    }`}
                  >
      ...
      {activeTab === "chat" && (
        <div className="fixed top-[56px] left-0 right-0 bottom-0 flex w-full bg-[#F0F2F5] dark:bg-[#18191A] z-40 overflow-hidden">
          ...
          {isCreatingGroup ? (
            ...
            <div className="flex-1 bg-[#F0F2F5] dark:bg-[#18191A] flex flex-col h-full">
              {/* Header */}
              <div className="px-6 py-5 bg-white dark:bg-[#242526] border-b border-gray-200 dark:border-[#3E4042] flex items-center justify-between shrink-0">
                <div>
              ...
              {/* List */}
              <div className="flex-1 overflow-y-auto sidebar-scrollbar p-4 grid grid-cols-2 gap-2 content-start">
                {selectedNewChatUsers.map(idx => (
                  <div key={idx} className="flex items-center gap-3 px-4 py-3 bg-white dark:bg-[#242526] rounded-xl border border-gray-100 dark:border-[#3E4042] hover:shadow-sm dark:hover:border-[#4E4F50] transition-all group">
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-full bg-gray-100 dark:bg-[#3A3B3C] hover:bg-red-50 dark:hover:bg-red-900/30 hover:text-red-500 flex items-center justify-center text-gray-400 transition-all opacity-0 group-hover:opacity-100"
                    >
            ...
            <div className="w-[360px] bg-white dark:bg-[#242526] border-l border-gray-200 dark:border-[#3E4042] flex flex-col shrink-0">
              ...
              {selectedFriendsToAdd.length > 0 && (
                <div className="px-4 py-3 border-t border-gray-200 dark:border-[#3E4042] bg-white dark:bg-[#242526] shrink-0">
                  <button
                    onClick={() => {
                      setSelectedNewChatUsers(selectedFriendsToAdd);
