          ...
          <div className="space-y-4">
            ...
            {activeTab === "mencari" ? (
              ...
              <div className="space-y-4">
                ...
                {/* Filters */}
                <div className="bg-white dark:bg-[#242526] rounded-xl shadow-sm border border-gray-100 dark:border-[#3E4042] p-2 flex flex-col divide-y divide-gray-100 dark:divide-[#3E4042]">
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`w-full text-left px-3 py-2.5 text-[13.5px] font-medium transition-colors flex items-center gap-3 py-3 ${
