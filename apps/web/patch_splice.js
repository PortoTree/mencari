...
const matchLine = lines.findIndex(l => l.includes('isChatListSettingsOpen &&'));
if (matchLine !== -1) {
  ...
  const replacementLines = `                         <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-[#242526] rounded-lg shadow-[0_0_15px_rgba(0,0,0,0.1)] border border-gray-100 dark:border-[#3E4042] py-1.5 z-50">
  ...
  lines.splice(matchLine + 1, endLine - matchLine - 1, ...replacementLines);
